...
beforeEach(async() => {
    ...
    VALUES('12341234', 'https://amazon.com/test', 'Elm', 'English', 200, 'Testing House', 'The Test', 2021)
    RETURNING isbn`);
...
describe("POST /books", function(){
    test("Creates a new book", async function(){
        ...
        .send({
            isbn: "456456",
            amazon_url: "https://guitar.com",
            author: "batman",
            language: "english",
            pages: 450,
            publisher: "Gotham Publishers",
            title: "The Guitar",
            year: 2003
        });
...
describe("PUT /books/:id", function(){
    ...
    test("Responds 404 if can't find a book", async function(){
        await request(app)
